...
public class BookReturn extends JFrame implements ActionListener, MouseListener {
	...
	public BookReturn() {
		...
		updateJP.setBorder(new TitledBorder(null, "图书归还", TitledBorder.LEADING,
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == borrowJB) {
			/*// JOptionPane.showMessageDialog(this, "归还按钮被点击！");
			String readerid = null, ISBN = null, date = null;
			readerid = readeridJTF.getText();
			ISBN = ISBNJTF.getText();
			date = dateJTF.getText();
			int r = 0;
			r = BorrowBookDao.returnBook(readerid, ISBN, date);
			if (r == 0) {
				JOptionPane.showMessageDialog(this, "归还失败，检查信息是否正确！");
			} else {
